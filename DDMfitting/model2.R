...
# Prior distributions
p.mean <- c(a=2, v.low=3, v.high=3, v_bias.biastrial=0, z=0.5, t0=0.3)
p.scale <-c(a=2, v.low=3, v.high=3, v_bias.biastrial=1, z=0.1, t0=0.3)
p.prior <- prior.p.dmc(
  dists = rep("tnorm",6),
  p1=p.mean,                           
  p2=p.scale,
...
# p.vector <- c("a"=1, "v.low"=1, "v.high"=1, "z"=0.5, "z_bias.biastrial"=0, "v_bias.biastrial"=1, "t0"=0)
